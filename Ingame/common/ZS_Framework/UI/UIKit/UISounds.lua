local Sound, Sound_5, u104, u24, u44, u64, u84
...
if not UIKitHover then
    ...
    Sound.Parent = SoundService
    u24 = Sound
elseif UIKitHover:IsA("Sound") then
...
if not UIKitClick then
    ...
    u44 = Sound_2
elseif UIKitClick:IsA("Sound") then
...
if not UIKitClose then
    ...
    u64 = Sound_3
elseif UIKitClose:IsA("Sound") then
...
if not UIKitPurchasePrompt then
    ...
    u84 = Sound_4
elseif UIKitPurchasePrompt:IsA("Sound") then
...
return {
    ...
    PurchaseSound = u84,
    RewardSound = u104,
    Hover = function() -- Line: 33 -- upvalues: u24 (val)
        u24:Play()
    end,
    Click = function() -- Line: 36 -- upvalues: u44 (val)
        u44:Play()
    end,
    Close = function() -- Line: 39 -- upvalues: u64 (val)
        u64:Play()
    end,
    Purchase = function() -- Line: 42 -- upvalues: u84 (val)
        u84:Play()
    end,
    Reward = function() -- Line: 45 -- upvalues: u104 (val)
        u104:Play()
    end,
}