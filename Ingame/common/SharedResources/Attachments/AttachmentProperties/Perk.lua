return {
    ...
    AE21C_Overload = {
        ...
        Sort = 0,
        Pros = {
            "Increased Damage [+4% Damage]",
            "Increased Ammo [9999]",
            "You explode upon running out of stamina!",
        },
        Cons = {
    ...
    Hatchet_ArmorBreaker = {
        ...
        Cons = {
            "Decreased Active Movement Speed [-10%]",
            "Increased Stamina Consumption",
            "40s Cooldown after swinging",
        },
    },
    AR15_SHARPS = {
        ID = "P17",
    ...
    Hammer_LightweightCore = {
        ...
        Pros = {
            "Increased Swing Speed[+25%] ",
            "Less Stamina Consumed per Swing [-20%]",
            "Increased Draw/Holster Speed [+15%]",
        },
    ...
    Hammer_HeavyweightCore = {
        ...
        Cons = {
            "Decreased Swing Speed[-40%] ",
            "More Stamina Consumed per Swing [+50%]",
            "Decreased Draw/Holster Speed [-20%]",
        },
    },
    Winchester_CompoundShot = {
        ...
        Cons = {
            "Decreased Stored Ammo [30]",
            "Decreased Penetration Damage Reduction [-25%]",
            "Increased Vertical Recoil [+50%]",
        },
    },
}