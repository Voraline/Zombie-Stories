...
v2[4].PotentialAttachments = { v1.HP, v1.AP, v1["More Mags"] }
...
v2[6].PotentialAttachments = { v1["Ext. Magazines"] }
v2[7] = {
	["Name"] = "Bottom Rail",
	["PotentialAttachments"] = nil,
	["PotentialAttachments"] = {
...
for _, v7 in v2[8].PotentialAttachments do
	local v8 = v2[7].PotentialAttachments
	table.insert(v8, v7)
end
return v2