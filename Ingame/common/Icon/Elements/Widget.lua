return function(p_u_1, p_u_2)
	...
	v5.Parent = v_u_4
	local v_u_6 = require("./Menu")(p_u_1)
	...
	v_u_11.Parent = v_u_9
	require("../Features/Gamepad").registerButton(v_u_11)
	...
	local v_u_23 = 0
	local function v61(_) -- name: handleLabelAndImageChangesUnstaggered
	...
	local v_u_62 = require("../Utility").createStagger(0.01, v61)
	local v_u_63 = true
	...
	local function v68() -- name: updateBorderSize
