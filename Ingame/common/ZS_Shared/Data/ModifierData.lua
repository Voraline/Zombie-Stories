return {
    TripleZombies = {
        ...
        StatText = "+200%",
        VariableAdditions = {ZombieSpawnRate = 2},
    },
    DoubleZombies = {
        Name = "Double Zombies",
        ...
        Grouping = "ZombieAmount",
        StatText = "+100%",
        VariableAdditions = {ZombieSpawnRate = 1},
    },
    ExtraZombies = {
        Name = "Extra Zombies",
        ...
        Grouping = "ZombieAmount",
        StatText = "+50%",
        VariableAdditions = {ZombieSpawnRate = 0.5},
    },
    FewerZombies = {
        Name = "Fewer Zombies",
    ...
    HeadshotOnly = {
        ...
        VariableSets = {HeadshotOnly = true},
    },
    FastZombies = {
        Name = "Fast Zombies",
        ...
        StatText = "+25%",
        VariableAdditions = {ZombieSpeed = 0.25},
    },
    UsainBoltZombies = {
        ...
        Grouping = "ZombieSpeed",
        StatText = "+50%",
        VariableAdditions = {ZombieSpeed = 0.5},
    },
    SlowZombies = {
        Name = "Slow Zombies",
    ...
    FragileZombies = {
        ...
        StatText = "-50%",
        VariableAdditions = {ZombieHealth = -0.5},
    },
    TankyZombies = {
        Name = "Tanky Zombies",
    ...
    BulletSpongeZombies = {
        ...
        Grouping = "ZombieHealth",
        StatText = "+100%",
        VariableAdditions = {ZombieHealth = 1},
    },
    OneDown = {
        Name = "One Down",
    ...
    TakeMoreDamage = {
        ...
        StatText = "+50%",
        VariableAdditions = {PlayerDamageTaken = 0.5},
    },
    Take250Damage = {
        ...
        Grouping = "PlayerDamageTaken",
        StatText = "+150%",
        VariableAdditions = {PlayerDamageTaken = 1.5},
    },
    Take5xDamage = {
        ...
        Grouping = "PlayerDamageTaken",
        StatText = "+400%",
        VariableAdditions = {PlayerDamageTaken = 4},
    },
    EverythingOneShots = {
        ...
        XPMultiplier = 0.2,
        Grouping = "PlayerDamageTaken",
        VariableSets = {PlayerDamageTaken = 1000},
    },
    ExplodingZombies = {
        ...
        VariableSets = {ZombiesExplodeOnDeath = true},
    },
    ExplodingZombiesDoMoreDamage = {
        ...
        Grouping = "ZombiesExplodeOnDeath",
        StatText = "+100%",
        VariableAdditions = {ZombieExplodeDamage = 1},
        VariableSets = {ZombiesExplodeOnDeath = true},
    },
    ExplodingZombiesDoLessDamage = {
        ...
        Grouping = "ZombiesExplodeOnDeath",
        StatText = "-50%",
        VariableAdditions = {ZombieExplodeDamage = -0.5},
        VariableSets = {ZombiesExplodeOnDeath = true},
    },
    PlayersRunFaster = {
        ...
        StatText = "+25%",
        VariableAdditions = {PlayerSpeed = 0.25},
    },
    SnailMovement = {
        Name = "Snail Movement",
        ...
        Grouping = "PlayerSpeed",
        StatText = "-50%",
        VariableAdditions = {PlayerSpeed = -0.5},
    },
    PlayersRunSlower = {
    ...
    Wallhacks = {
        ...
        XPMultiplier = -0.15,
        Grouping = "Wallhacks",
        VariableSets = {WallhackEnabled = true},
    },
    MotionSickness = {
        ...
        VariableSets = {MotionSicknessEnabled = true},
    },
    FastGuns = {
        Name = "Fast Guns",
        ...
        Grouping = "FireRate",
        StatText = "+25%",
        VariableAdditions = {FireRate = 0.25},
    },
    GunsBlazing = {
        Name = "Guns Blazing",
        ...
        Grouping = "FireRate",
        StatText = "+50%",
        VariableAdditions = {FireRate = 0.5},
    },
    SlowGuns = {
        Name = "Slow Guns",
    ...
    NoAbility = {
        ...
        VariableSets = {GiveAbility = false},
    },
    NoPrimary = {
        Name = "No Primary",
        ...
        VariableSets = {GivePrimary = false},
    },
    SecondaryOnly = {
        Name = "Secondary Only",
        ...
        VariableSets = {GivePrimary = false, GiveMelee = false},
    },
    MeleeOnly = {
        Name = "Melee Only",
        ...
        VariableSets = {GiveSecondary = false, GivePrimary = false},
    },
    ScionsOfVexary = {
        ...
        VariableSets = {ForcePrimary = "1311", ForceSecondary = "2147", ForceMelee = "3065"},
    },
    TheProfessional = {
        ...
        VariableSets = {ForcePrimary = "1315", ForceSecondary = "2137", ForceMelee = "3105"},
    },
    HalfBlind = {
        Name = "Half Blind",
        ...
        XPMultiplier = 0.02,
        Grouping = "Blindness",
        VariableSets = {HalfBlindEnabled = true},
    },
    NoSliding = {
        Name = "No Sliding",
        ...
        XPMultiplier = 0.07,
        Grouping = "Sliding",
        VariableSets = {SlidingEnabled = false},
    },
    StoneColdKiller = {
        ...
        StatText = "-66%",
        VariableAdditions = {WeaponSpread = -0.66},
    },
    BadShot = {
        Name = "Bad Shot",
    ...
    QuickAttackZombies = {
        ...
        StatText = "+50%",
        VariableAdditions = {ZombieAttackSpeed = 0.5},
    },
    SuperQuickAttackZombies = {
        ...
        Grouping = "ZombieAttackSpeed",
        StatText = "+100%",
        VariableAdditions = {ZombieAttackSpeed = 1},
    },
    SlowAttackZombies = {
        ...
        Grouping = "ZombieAttackSpeed",
        StatText = "-33%",
        VariableAdditions = {ZombieAttackSpeed = -0.33},
    },
    SuperSlowAttackZombies = {
        ...
        Grouping = "ZombieAttackSpeed",
        StatText = "-66%",
        VariableAdditions = {ZombieAttackSpeed = -0.66},
    },
    AggressiveZombies = {
        ...
        VariableAdditions = {ZombieAttackDelay = -0.5},
    },
    CalmZombies = {
        Name = "Calm Zombies",
    ...
    BreakdancingZombies = {
        ...
        VariableSets = {BreakdancingZombiesEnabled = true},
    },
    PartyMode = {
        Name = "Party Mode",
        ...
        VariableSets = {PartyModeEnabled = true, DefaultMusicEnabled = false},
    },
}