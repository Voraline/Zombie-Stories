...
return function(p1, p2, p3) -- Line: 16 -- upvalues: Oklab (val)
    ...
    if v6 == "Color3" then
        ...
        v4 = Oklab.to(p2)
        v5 = v3:Lerp(v4, p3)
        return Oklab.from(v5, false)
    end
    if v6 == "ColorSequenceKeypoint" then
        v1 = p2
        v2 = p1
        v3 = Oklab.to(v2.Value)
        v4 = Oklab.to(v1.Value)
        v5 = (v1.Time - v2.Time) * p3 + v2.Time
        local v7 = v3:Lerp(v4, p3)
        return ColorSequenceKeypoint.new(v5, Oklab.from(v7, false))
    end
    if v6 == "DateTime" then
        v2 = p1
