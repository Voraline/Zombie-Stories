return {
    ...
    BlockOffset = (CFrame.new(0, 0, 0)) * CFrame.Angles(0.17453292519943295, 0, 0.05235987755982989),
    HolsterCF = (CFrame.new(0, -2, 3)) * CFrame.Angles(-0.4363323129985824, 0, 0),
    AttachmentNodeData = require("@game/ReplicatedStorage/common/SharedResources/Attachments/Platforms/Hammer_Mods"),
}