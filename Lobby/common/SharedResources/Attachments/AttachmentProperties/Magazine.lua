...
v1["Nighthaven 9mm Conv"] = {
    ...
    Description = "Death",
    Sort = 0,
    Pros = {"Increased Magazine Capacity [+9]", "Increased Reserves [+22]", "Increased Firerate [925 RPM]", "Decreased Recoil [-25%]"},
