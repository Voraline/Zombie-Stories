...
v1[4] = {
    Name = "Perk",
    PotentialAttachments = {AttachmentProperties.Flechette, AttachmentProperties.Quickload, AttachmentProperties.Stormblitz},
}
v1[6] = {
    Name = "Muzzle",
...
v1[8] = {
    Name = "Misc Rail",
    PotentialAttachments = {AttachmentProperties["Point Aim"]},
}
