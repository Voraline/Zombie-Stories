...
v1.AssetId = v2
v1.Difficulties = {Easy = true, Medium = true, Hard = true}
v2 = {
    Name = "Area 51",
    UsesFuture = false,
...
v2.AssetId = v3
v3 = {Easy = true, Medium = true, Hard = true}
v2.Difficulties = v3
v8[1] = v9
v8[2] = v1
v8[3] = v2
...
v9.AssetId = v1
v1 = {Easy = true, Medium = true, Hard = true}
v9.Difficulties = v1
v8[1] = v9
v7.Chapters = v8
v6.DEAH = v7
...
v2.AssetId = v3
v2.Difficulties = {Easy = true, Medium = true, Hard = true}
v3 = {
    Name = "No Mercy",
    UsesFuture = true,
...
v3.AssetId = v4
v3.Difficulties = {Easy = true, Medium = true, Hard = true}
v8[1] = v9
v8[2] = v1
v8[3] = v2
v8[4] = v3
    ...
    Chapters = {
        {
            ...
            Difficulties = {Easy = false, Medium = false, Hard = true},
        },
        {
            Name = "Live Event",
            AssetId = 7107528696,
