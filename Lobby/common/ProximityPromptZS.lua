...
if v_u_3:IsServer() then
	...
	v22 = require(v6.BindUtil)
	v23 = require(v6.InputLabel)
	v_u_20 = require(v7.Fusion)
	v_u_21 = require("@game/ReplicatedStorage/common/skillTree/SkillTreeData")
	task.spawn(function()
...
if not v_u_25 then
	...
	updateTextScaleWidth()
	updateScaleWidth()
	v22.InputMethodChanged:Connect(v101)
	v_u_15.Visible = v22.getInputMethod() == "Touch"
	v22.InputMethodChanged:Connect(function(p105) -- name: updateTouchButtonVisibility
		-- upvalues: (copy) v_u_15
		v_u_15.Visible = p105 == "Touch"
	end)
	v22.new("PromptInteract", function()
		-- upvalues: (ref) v_u_31
		v_u_31 = true
	end, function()
...
v_u_3:BindToRenderStep("ProximityPromptProgress", Enum.RenderPriority.Camera.Value - 1, function(p106)
	-- upvalues: (copy) v_u_69, (ref) v_u_21, (ref) v_u_20, (ref) v_u_31, (ref) v_u_38, (ref) v_u_36, (ref) v_u_37, (ref) v_u_29
	if v_u_69.openedPrompt then
		local v107 = not (v_u_21 and v_u_21.InteractSpeedMult) and 1 or v_u_20.peek(v_u_21.InteractSpeedMult)
