...
function u0.ApplySkinPalette(p1, p2, p3, p4) -- Line: 4
...
function u0.ApplyTexture(p1, p2, p3, p4, p5) -- Line: 15
...
function u0.ApplyGalaxy(p1, p2) -- Line: 36 -- upvalues: u0 (val)
    ...
    for i, j in p2.Weapon:QueryDescendants("BasePart") do
        v2 = u0
        v1 = {j}
        v2:ApplyTexture("rbxassetid://1818175145", v1, {Name = "Animate", StudsPerTileU = 2, StudsPerTileV = 2})
    end
end
