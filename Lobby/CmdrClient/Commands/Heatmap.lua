return {
    ...
    Aliases = {"hm"},
    Args = {
        {Type = "heatmapMetric", Name = "metric", Description = "samples, visitors, or dwell", Default = "samples"},
        {Type = "heatmapLayer", Name = "layer", Description = "move, seat, or both", Default = "move"},
        {Type = "integer", Name = "limit", Description = "Maximum number of cells to draw (up to 6000)", Default = 2000},
