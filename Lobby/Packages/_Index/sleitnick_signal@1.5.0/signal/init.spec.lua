local function AwaitCondition(p1, p2) -- Line: 1
    local v1 = os.clock()
    while not (p1()) do
        if not (p2 or 10 >= os.clock() - v1) then
            return false
        end
        task.wait()
    end
...
return function() -- Line: 15 -- upvalues: AwaitCondition (val)
    ...
    describe("Constructor", function() -- Line: 33 -- upvalues: Parent (val), u4 (ref), AwaitCondition (upval)
        ...
        it("should create a proxy signal and connect to it", function() -- Line: 44 -- upvalues: Parent (upval), AwaitCondition (upval)
            ...
            expect(AwaitCondition(function() -- Line: 51 -- upvalues: u19 (ref)
                return u19
            end, 2)).to.equal(true)
            v1:Destroy()
        end)
    ...
    describe("FireDeferred", function() -- Line: 58 -- upvalues: u4 (ref), AwaitCondition (upval)
        it("should be able to fire primitive argument", function() -- Line: 59 -- upvalues: u4 (upval), AwaitCondition (upval)
            local u0 = nil
            u4:Connect(function(p1) -- Line: 62 -- upvalues: u0 (ref)
                u0 = p1
            end)
            u4:FireDeferred(10)
            expect(AwaitCondition(function() -- Line: 66 -- upvalues: u0 (ref)
                local v1 = u0 == 10
                return v1
            end, 1)).to.equal(true)
        end)
        it("should be able to fire a reference based argument", function() -- Line: 71 -- upvalues: u4 (upval), AwaitCondition (upval)
            local u0 = {10, 20}
            local u3 = nil
            u4:Connect(function(p1) -- Line: 74 -- upvalues: u3 (ref)
                u3 = p1
            end)
            u4:FireDeferred(u0)
            expect(AwaitCondition(function() -- Line: 78 -- upvalues: u0 (val), u3 (ref)
                local v1 = u0 == u3
                return v1
            end, 1)).to.equal(true)
        end)
    ...
    describe("Fire", function() -- Line: 84 -- upvalues: u4 (ref)
        it("should be able to fire primitive argument", function() -- Line: 85 -- upvalues: u4 (upval)
            local u0
            u4:Connect(function(p1) -- Line: 88 -- upvalues: u0 (ref)
                u0 = p1
            end)
            u4:Fire(10)
            expect(nil).to.equal(10)
        end)
        it("should be able to fire a reference based argument", function() -- Line: 95 -- upvalues: u4 (upval)
            local u3
            local v1 = {10, 20}
            u4:Connect(function(p1) -- Line: 98 -- upvalues: u3 (ref)
                u3 = p1
            end)
            u4:Fire(v1)
            expect(nil).to.equal(v1)
        end)
    end)
    describe("ConnectOnce", function() -- Line: 106 -- upvalues: u4 (ref)
        it("should only capture first fire", function() -- Line: 107 -- upvalues: u4 (upval)
            local u0
            local v1 = u4:ConnectOnce(function(p1) -- Line: 109 -- upvalues: u0 (ref)
                u0 = p1
            end)
    ...
    describe("DisconnectAll", function() -- Line: 132 -- upvalues: u4 (ref)
        it("should disconnect all connections", function() -- Line: 133 -- upvalues: u4 (upval)
            ...
            expect(#v1:GetConnections()).to.equal(2)
            u4:DisconnectAll()
            v1 = nil
            if not v1 then
                v1 = u4
            end
            expect(#v1:GetConnections()).to.equal(0)
        end)
    end)
    describe("Disconnect", function() -- Line: 142 -- upvalues: u4 (ref), AwaitCondition (upval)
        it("should disconnect connection", function() -- Line: 143 -- upvalues: u4 (upval)
            ...
            expect(#v2:GetConnections()).to.equal(1)
            v1:Disconnect()
            v2 = nil
            if not v2 then
                v2 = u4
            end
            expect(#v2:GetConnections()).to.equal(0)
        end)
        it("should still work if connections disconnected while firing", function() -- Line: 150 -- upvalues: u4 (upval)
            local u0 = 0
            local u1 = nil
            u4:Connect(function() -- Line: 153 -- upvalues: u0 (ref)
                u0 = u0 + 1
            end)
            u4:Connect(function() -- Line: 160 -- upvalues: u0 (ref)
                u0 = u0 + 1
            end)
            u4:Fire()
        ...
        it("should still work if connections disconnected while firing deferred", function() -- Line: 167 -- upvalues: u4 (upval), AwaitCondition (upval)
            local u0 = 0
            local u1 = nil
            u4:Connect(function() -- Line: 170 -- upvalues: u0 (ref)
                u0 = u0 + 1
            end)
            u4:Connect(function() -- Line: 177 -- upvalues: u0 (ref)
                u0 = u0 + 1
            end)
            u4:FireDeferred()
            expect(AwaitCondition(function() -- Line: 181 -- upvalues: u0 (ref)
                local v1 = u0 == 3
                return v1
            end)).to.equal(true)
        end)
