...
function u13.Wrap(p1) -- Line: 186 -- upvalues: u13 (val)
    ...
    local v2 = "Argument #1 to Signal.Wrap must be a RBXScriptSignal; got " .. (typeof(p1))
    assert(v1, v2)
    local u17 = u13.new()
...
function u13.Wait(p1) -- Line: 356
    ...
    local u3 = nil
    local u4 = false
    local v1 = p1:Connect(function(...) -- Line: 360 -- upvalues: u4 (ref), u3 (ref), u2 (val)
        if u4 then
            return
        end
        u4 = true
